                ...
                <ul class="nav navbar-nav" id="navBar">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <span data-localize="nav.userInfo">User Information</span>
                            <span class="caret" />
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="BasicUser.aspx" data-localize="nav.userBasic">
                                    Basic Information
                                </a>
                            </li>
                            <li>
                                <a href="DeliveryInfo.aspx" data-localize="nav.userDelivery">
                    ...
                    <li>
                        <a href="Registration.aspx" data-localize="nav.register">
                            Become a member
                        </a>
                    </li>
                </ul>
            ...
            <div class="drawer-contents">
                ...
                <div class="drawer-body">
                    <p data-localize="menu.body">
                        This page is for BSU Pizza store, you can order variety flavors of pizza on our
                        website.
            ...
            <form id="ConfirmForm" class="form-horizontal" runat="server">
                ...
                <div class="row"> <!-- Start row -->
                    <div class="col-sm-offset-3">
                        <asp:Label 
                            ID="Label2" 
                            runat="server" 
                            Text="Your Shopping Cart is showing below:"
                            Font-Size="X-Large">
                        </asp:Label>
                    </div>
                </div> <!-- Close row -->
                ...
                <div class="form-group"> <!-- Start AddressType -->
                    <asp:Label 
                        ...
                        runat="server" 
                        Text="AddressType:" 
                        CssClass="col-sm-4 control-label" 
                        for="TextBoxAddressType">
                    </asp:Label>
                    <div class="col-sm-4">
                        <asp:TextBox 
                            ID="TextBoxAddressType" 
                            class="form-control"
                            runat="server">
                        </asp:TextBox>
                    </div>
                ...
                <div class="form-group"> <!-- Start AddressLine2 -->
                    <asp:Label 
                        ...
                        Text="AddressLine2:" 
                        CssClass="control-label col-sm-4" 
                        for="TextBoxAddressLine2">
                    </asp:Label>
                    <div class="col-sm-4">
                        <asp:TextBox 
                            ID="TextBoxAddressLine2" 
                            class="form-control"
                            runat="server">
                        </asp:TextBox>
                    </div>
