        ...
        <header class="container">
            <nav class="collapse navbar-collapse navbar-inverse"> <!-- Menu bar-->
                ...
                <ul class="nav navbar-nav">
                    ...
                    role="button" aria-haspopup="true" aria-expanded="false">User Information <span class="caret" /></a>
        ...
        <div id="drawerMenu" class="drawer dw-xs-8 fold">
            <div class="drawer-controls visible-xs-block">
                <a 
                    ...
                    style="font-size: 50px; padding: 0px 10px 0px 10px">
                    ≡
                </a>
            </div>
            ...
            <div class="row"> <!-- Start row -->
                <div class="col-md-6 hidden-sm hidden-xs">
                    ...
                    <asp:Image 
                        ID="ImageChicken" 
                        runat="server" 
                        ImageUrl="~/images/GrilledChicken.png"
                        CssClass="GrilledChicken" 
                        Visible="False" />
                    <asp:Image 
                        ID="ImagePepperoni" 
                        runat="server" 
                    ...
                    <asp:Label 
                        ID="LabelPrice" 
                        runat="server" 
                        style="position:absolute; left:150px; top:350px" 
                        Font-Size="16pt" 
                        ForeColor="White">
                    ...
                    <form runat="server" class="form-horizontal" id="FormOrder"><!--Start form-->
                        ...
                        <div class="form-group"><!-- Pizza style group-->
                            <asp:Label 
                                ...
                                runat="server" 
                                class="control-label col-sm-4" 
                                Text="Choose Pizza Style:">
                            </asp:Label>
                            <div class="col-sm-8">
                                <asp:DropDownList 
                                    ID="DropDownListPizzaStyle" 
                                    runat="server" 
                                    class="form-control">
                        ...
                        <asp:Button 
                            ...
                            runat="server" 
                            Text="Order" 
                            class="btn btn-lg btn-primary col-sm-offset-4" 
